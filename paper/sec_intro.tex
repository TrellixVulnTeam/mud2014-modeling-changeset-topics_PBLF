...
These underlying topics are found using a statistic analysis, through the use of algorithms that are designed to uncover a thematic structure. \cite{Blei2012}
...
Topics are discovered by taking a distribution over the vocabulary, which creates a set of topics for each document in the corpus. \cite{Blei2012}
...
\attn{Research Q3:
    Are commit log messages accurate summaries of the changesets they represent?
    }
