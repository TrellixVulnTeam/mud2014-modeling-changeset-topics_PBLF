% vim:syntax=tex
Software developers commonly find themselves dealing with large, dated repositories before delving into a project or specific task (e.g. feature location, maintenance, etc.).
