...
which is written in C. Table~\ref{tab:system} outlines the releases for
each system studied.
...
\small
\begin{tabular}{l|ll}
    System      & Release & Commit SHA
    \\
    \hline
    \ant        & 1.9.4   & 1c927b15
    \\
    \aspectj    & 1.8.0   & 5a5bef1e
    \\
    \jodatime   & 2.3     & b0fcbb95
    \\
    \postgres   & 9.3.4   & d4f8dde3
    \\
    \hline
\end{tabular}
\label{tab:systems}
...
Topic distinctiveness has been show to be an effective measure for qualitative
...
Table~\ref{tab:systemcorpora} shows the document count and term count for each system.
